 ...
 * solution using the divide and conquer approach分治法, which is more subtle微妙.
 * 
...
public class MaximumSubarray {
	...
	private static int maxArray(int[] nums, int left, int right, int maxV) {
		if(left>right){
